	...
	*/
	...
	$portfolio_meta_boxes = array(	
		...
		"Choose Sidebar" => array(
			...
			'name'=>'post-option-choose-sidebar',
			'type'=>'combobox',
		),

		"Post Header" => array(
			'type'=>'textarea',
			'name'=>'post-option-header',
			'title'=> __('PAGE HEADER', 'gdl_back_office')
		),				
	...
	function add_portfolio_option_element(){
		...
		// init array
		$portfolio_meta_boxes['Choose Sidebar']['options'] = array_merge( array('None'), get_sidebar_name());
