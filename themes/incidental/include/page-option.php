<?php 
	...
	*/
	...
	$page_meta_boxes = array(
			...
			'name'=>array(
				...
				'Blog'=>array(		
					'item-size'=>array(
						...
						'options'=>array('0'=>'1/2 Grid Style', '1'=>'1/1 Full Thumbnail'),
						'type'=>'combobox',
		...
		"Choose Sidebar" => array(
			'title'=> __('CHOOSE SIDEBAR', 'gdl_back_office'),
			'name'=>'page-option-choose-sidebar',
			'type'=>'combobox',
		),
		...
		"Enable Page Content Area" => array(
			'type'=>'combobox',
			'name'=>'page-option-enable-content-area',
			'options'=> array('On', 'On-Off', 'Off'),
			'title'=> __('ENABLE PAGE CONTENT AREA', 'gdl_back_office'),
		),	

		"Enable Page Caption Nav" => array(
			'type'=>'combobox',
			'name'=>'page-option-enable-nav',
			'options'=> array('Yes', 'No'),
			'title'=> __('ENABLE PAGE BG CAPTION NAV', 'gdl_back_office'),
		),			

		"Enable Page Thumbnail" => array(
			'type'=>'combobox',
			'name'=>'page-option-enable-thumbnail',
			'options'=> array('Yes', 'No'),
			'title'=> __('ENABLE PAGE BG THUMBNAIL', 'gdl_back_office'),
		),			
		
		
		"Page First State Style" => array(
			'type'=>'combobox',
			'name'=>'page-option-first-state',
			'options'=> array('Content', 'Thumbnail'),
			'title'=> __('PAGE FIRST STATE', 'gdl_back_office'),
		),	

		"Top Slider Type" => array(
			'title'=> __('SLIDER BACKGROUND', 'gdl_back_office'),
	...
	function add_page_option_element(){
		...
		$page_meta_boxes['Choose Sidebar']['options'] = array_merge( array('None'), get_sidebar_name());
		$page_meta_boxes['Top Slider Type']['options'] = array_merge( array('Current Page'), get_title_list('gallery'));
