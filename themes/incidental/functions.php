<?php 
	...
	*/
	...
	// constants
	define('THEME_SHORT_NAME','icd'); 
	define('THEME_FULL_NAME','Incidental');
	...
	$gdl_sidebar_icon_type = get_option(THEME_SHORT_NAME.'_navigation_icon_type','light');
	...
	include_once($temp_root . 'include/plugin/description-menu.php'); // Menu description
