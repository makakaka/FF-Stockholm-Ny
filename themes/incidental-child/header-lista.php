...
<!-- Get Logo -->
						...
						<?php 
						$referens = '';
 						$GLOBALS['referens'] = $referens;
						if (isset($_REQUEST['referens'])) {
 							$referens = $_GET["referens"];
 							$GLOBALS['referens'] = $referens;
 						}
 						if (!empty($referens)) {
						?>
							<ul id="menu-main-navigation" class="sf-menu sf-js-enabled sf-shadow"><li class="menu-item menu-item-type-post_type menu-item-object-page page_item"><a href="http://www.fantasticfrank.se/kopa-bostad/" style="color: #fff!important; background-color: #000!important;">alla till salu</a></li></ul>			
						<?php } else { ?>
							<ul id="menu-main-navigation" class="sf-menu sf-js-enabled sf-shadow"><li class="menu-item menu-item-type-post_type menu-item-object-page page_item"><a href="http://www.fantasticfrank.se/kopa-bostad/?referens=true" style="color: #fff!important; background-color: #000!important;">sålda/referens</a></li></ul>
						<?php } ?>
						</div>		
			...
			<div class='gdl-page-item' id='gdl-page-item'>
				<div class='gdl-inner-page-item gdl-inner-page-item-2 gdl-inner-page-item-lista masonry' id='gdl-inner-page-item' >