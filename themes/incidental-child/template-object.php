...
// SURR-funktioner
function get_surr($gid_in) {

  	$surrLista = prepare_vitec( );
	...
	$theFind = '';
 	foreach ($surrLista as $key=> $row) {
  		if ($row["gid"] == $gid_in) {
  			if(empty($theFind)) {
  				$theSurr .= '<h3>Buzz om bostaden</h3>';
  				$theSurr .= '<div class="shortcode-list shortcode-list-none">';
  				$theSurr .= '<ul>';
  				$theFind = 'X';
  			}
  			$theSurr .= '<li>-&nbsp;<a class="underline" href="' . $row["http"] . '" >' . $row["surr"] . '</a></li>';
  		}
	}
	if ($theFind == 'X') {
  		$theSurr .= '</ul>';
...
// GLOBALA VARIABLER, används i header
...
<div class="sixteen columns wrapper">
	<div class="eight columns  gdl-first ">
		<div class="gdl-column-item">
			...
			<?php if ( !empty($saljRubrik) ) { ?><p><strong><?php echo "$saljRubrik" ?></strong></p> <?php } ?>
...
<div class="wpcf7-response-output wpcf7-display-none"></div>
	...
	<div class="four columns ">
		<div class="gdl-column-item">
				...
				<div class="shortcode-list shortcode-list-none">
					<ul>
						<li><div class="fb-like" data-href="<?php echo 'http://www.fantasticfrank.se/visa-bostad-hemnet.php?obj=' . $objID; ?>" data-send="true" data-layout="button_count" data-width="200" data-show-faces="false"></div></li>
					</ul>
				</div>
